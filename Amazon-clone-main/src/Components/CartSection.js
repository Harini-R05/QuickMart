    ...
    <>
      ...
      <div className="entire-section">
        <p
          style={{ margin: 0 }}
          className={
            CartItems ? `cart-head animate` : `cart-head`
          }
        >
          Your Cart
        </p>
                    ...
                    <div className="cart-all-data">
                      ...
                      <div className="cart-price">
                        <p className="cart-discount">
                          {convertToIndianRupees((item.price * item.quantity).toFixed(1))}
                        </p>
                        <p
                          style={
          ...
          >
            ...
            <div className="money-data">
              <div className="money-1">
                ...
                <p className="total-price">{convertToIndianRupees(SubTotal.toFixed(2))}</p>
              </div>
              <div
                style={
                  CorrectCode === true
              ...
              >
                ...
                <p className="item-discount2">(20%) - {convertToIndianRupees(DiscountPrice)}</p>
              </div>
              ...
              <div className="money-4">
                ...
                <p className="item-tax2">(5%) + {convertToIndianRupees(TaxPrice)}</p>
              </div>
            </div>
            <hr className="horizontal" />
            <div className="money-5">
              ...
              >
                {convertToIndianRupees(totalPrice1)}
              </p>
              <p
                style={
                  CorrectCode !== true
              ...
              >
                {convertToIndianRupees(totalPrice2)}
              </p>
            </div>
