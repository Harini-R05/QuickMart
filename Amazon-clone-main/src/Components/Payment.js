...
function Payment() {
  ...
  const TotalAmountInUSD = parseFloat(localStorage.getItem("TotalAmount")) || 0;
  const TotalAmountInINR = (TotalAmountInUSD * exchangeRate).toFixed(2);
  ...
  return (
    <>
      ...
      <div className="payment-page">
        ...
        <p className="main-amount">₹{TotalAmountInINR}</p>
      </div>
