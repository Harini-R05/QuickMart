...
function ProductPage() {
  ...
  const convertToIndianRupees = (amount) => {
    const conversionRate = 75.00; // Replace with the actual conversion rate
    const amountInRupees = amount * conversionRate;
          ...
          <div className="product-details">
            ...
            {product ? (
              <div className="product-actual-price">
                ...
                <p className="price-two">{convertToIndianRupees(product.price)}</p>
                <p className="mrp">{convertToIndianRupees(Math.round(product.price * 1.66))}</p>
              </div>
            ) : (
              ""
            )}
